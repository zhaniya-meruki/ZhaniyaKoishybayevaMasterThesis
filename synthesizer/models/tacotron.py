...
class Tacotron():
    ...
    def initialize(self, inputs, input_lengths, embed_targets, stream, mel_targets=None, 
        ...
        with tf.device(split_device):
            ...
            for i in range(hp.tacotron_num_gpus):
                tower_inputs.append(tf.reshape(p_inputs[i], [batch_size, hparams.T, hparams.img_size, hparams.img_size, input_size]))
            ...
            with tf.device(tf.train.replica_device_setter(ps_tasks=1, ps_device="/cpu:0",
                ...
                with tf.variable_scope("inference") as scope:
                    ...
                    encoder_cell = TacotronEncoderCell(
                        EncoderConvolutions3D(is_training, stream, hparams=hp, scope="encoder_convolutions"),
