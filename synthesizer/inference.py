...
class Synthesizer:
    ...
    def __init__(self, stream, verbose=True, low_mem=False, manual_inference=False):
        """
    ...
    def load(self):
        ...
        self._model = Tacotron2(None, hparams, self._stream)
    ...
    @staticmethod
    def _one_shot_synthesize_spectrograms(stream, checkpoint_fpath, texts, embeddings):
        # Load the model and forward the inputs
        tf.reset_default_graph()
        model = Tacotron2(checkpoint_fpath, hparams, stream)
