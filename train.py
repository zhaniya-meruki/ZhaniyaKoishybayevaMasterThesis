...
def prepare_run(args):
    ...
    all_images = get_image_list('train', args.data_root, args.stream)
    all_test_images = get_image_list('val', args.data_root, args.stream)        
...
if __name__ == "__main__":
    ...
    parser.add_argument("--stream", help="rgb, thr or both", required=True)
    ...
    tacotron_train(args, log_dir, hparams, args.stream)
